...
frame_ = [find(speed_grid==speed_for_subplot(1));find(speed_grid==speed_for_subplot(2));find(speed_grid==speed_for_subplot(3));find(speed_grid==speed_for_subplot(4))];
