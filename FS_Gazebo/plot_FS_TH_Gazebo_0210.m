...
load('.\FS_TH__2021-02-10-13-47-11_dataset2\FS_Gazebo_0210.mat')
%% plot these data
figure()
...
set(gcf, 'Color', 'w');
xlim([0 65])
eval(['export_fig ','Sim_newFS_Gazebo-speed_072620',' -pdf']);
...
xlim([0 65])
eval(['export_fig ','Sim_newFS_Gazebo-dist_072620',' -pdf']);
