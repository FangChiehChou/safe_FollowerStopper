%% 
function dx = mFS_simulation_model(t,x,uMin,uMax,r,v_lead)
...
if(length(v_lead)>1)
    v_lead_temp = interp1(v_lead(1,:),v_lead(2,:),t);
else
    v_lead_temp = v_lead;
end
...
v_rel = v_lead_temp-v_f;


u = dyn_modified_follower_stopper(d_rel,v_rel,v_f,uMin,uMax,r);
